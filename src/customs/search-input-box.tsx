  ...
  return (
    <div className="space-y-2">
      <div className="relative">
        <div className="pointer-events-none absolute inset-y-0 start-0 flex items-center justify-center pe-2 px-3 left-auto top-[1px] text-muted-foreground">
          <Search width={16} />
        </div>
        <Input
          id={id}
          className="ps-9 pe-11 border-none bg-[#F3F3FD] shadow-none h-[44px] w-[280px]"
          placeholder="Search..."
          type="search"
        />
